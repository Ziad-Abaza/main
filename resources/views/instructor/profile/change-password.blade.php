    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-12">
            <div class="card glass-card shadow-lg border-0 rounded-5 overflow-hidden">
                ...
                <!-- Header -->
                <div class="card-header text-center py-5 bg-gradient-to-r from-primary to-indigo text-white"
                ...
                <div class="card-body p-5">
                    <form action="{{ route('dashboard.profile.update-password') }}" method="POST">
                        ...
                        <div class="form-group position-relative mb-4">
                        <!-- Confirm Password -->
                        <x-inputs.password name="password_confirmation" label="Confirm Password"
