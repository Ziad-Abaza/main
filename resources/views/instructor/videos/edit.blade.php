...
@section('title', 'Edit Video - ' . $course->title)
@section('content')
        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-lg border-radius-lg overflow-hidden">
                ...
                <div class="card-header bg-light text-white d-flex align-items-center p-3">
                    ...
                    <h5 class="mb-0">Edit Video "{{ $video->title }}"</h5>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('dashboard.courses.videos.update', [$course, $video]) }}"
                        ...
                        <!-- Video Title -->
                        <div class="mb-4">
                            <x-inputs.text name="title" label="Video Title" :value="old('title', $video->title)"
                                required />
                        </div>
                        ...
                        <div class="mb-4">
                            <x-inputs.number name="order_in_course" label="Order in Course" min="1"
                                :value="old('order_in_course', $video->order_in_course)" />
                        </div>
