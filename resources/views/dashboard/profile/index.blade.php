            ...
            <div class="card shadow-sm border-0 rounded-4 overflow-hidden mb-4 position-relative">
                ...
                <div class="card-body text-center pt-5 px-4 pb-4">
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="{{route('console.profile.edit', $user->user_id)}}" class="btn btn-outline-secondary px-4 py-2 rounded-pill">
                            <i class="material-symbols-rounded me-1">edit</i>Edit Profile
                        </a>
                        <a href="{{route('console.profile.change-password')}}" class="btn btn-dark px-4 py-2 rounded-pill">
