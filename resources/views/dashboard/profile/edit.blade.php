        ...
        <div class="col-md-8 col-12">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('console.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="mb-4 text-center">
                            <label class="form-label d-block mb-2">Current Profile Picture</label>
                            <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('console.profile.index') }}" class="btn btn-outline-secondary px-4">
                                Cancel
                            </a>
