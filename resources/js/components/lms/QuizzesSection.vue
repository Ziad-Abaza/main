<template>
    ...
    >
        ...
        <!-- Header Section -->
        <div class="mb-12 relative z-10 px-6 py-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2
                        class="text-5xl font-black mb-4 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 bg-clip-text text-transparent leading-tight"
                    >
                        My Course Quizzes
                    </h2>
                    <div class="flex items-center space-x-4">
                        <div
                            class="w-24 h-1.5 bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 rounded-full"
                        ></div>
                        <div
                            class="w-12 h-1.5 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full opacity-60"
                        ></div>
                        <div
                            class="w-6 h-1.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-40"
                        ></div>
                    </div>
                </div>
                ...
                <div
                    v-if="!loading"
                    :class="[
                        'px-6 py-3 rounded-2xl backdrop-blur-lg border transition-all duration-300 hover:scale-105',
                        isDark
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-8">
                        ...
                        >
                            ...
                            <span v-if="quiz.status === 'scheduled'"
                                >Scheduled</span
                            >
        ...
        <div v-else class="flex flex-col items-center justify-center py-16">
            ...
            <p class="text-slate-400 text-center max-w-md">
                No quizzes found for your courses. Check back later for new
                quizzes!
            </p>
        </div>
    </div>
