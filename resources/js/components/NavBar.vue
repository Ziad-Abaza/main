<template>
  <nav
    :class="[
      ...
      !isDark && isScrolled ? 'bg-white border-b border-teal-100 shadow-md' : '',
    ]"
  >
    ...
    <div class="container mx-auto flex items-center justify-between relative z-10">
      ...
      <div class="hidden md:flex items-center space-x-1">
        <router-link
          ...
          :class="{
            'text-teal-400 bg-white/10 shadow-md': $route.path === link.path,
      ...
      >
        <div class="flex flex-col space-y-2 p-4">
          <router-link
            ...
            :class="{
              'text-teal-400 bg-white/10': $route.path === link.path,
            }"
...
:deep(.modern-navbar):not(.dark) .glass-card-premium {
  ...
  -webkit-backdrop-filter: blur(20px);
  border: 1px solid rgba(14, 165, 233, 0.15);
  box-shadow: 0 8px 32px rgba(14, 165, 233, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.9);
}
