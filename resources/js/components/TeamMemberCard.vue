<template>
  <div class="relative w-full h-80 perspective-1000">
    <!-- Front of card -->
    <div :class="[
      'absolute inset-0 rounded-2xl shadow-lg p-6 flex flex-col items-center transition-all duration-500 transform-style-preserve-3d backface-hidden',
      isDark
      ...
      <!-- Flip hint -->
      <div :class="[
        'absolute bottom-2 left-1/2 transform -translate-x-1/2 text-xs opacity-60',
    ...
    <!-- Back of card -->
    <div :class="[
      'absolute inset-0 rounded-2xl shadow-lg p-6 flex flex-col items-center transition-all duration-500 transform-style-preserve-3d backface-hidden rotate-y-180',
      isDark
...
@media (hover: hover) {
  .perspective-1000:hover .rotate-y-180 {
    transform: rotateY(0deg);
  }

  .perspective-1000:hover .rotate-y-0 {
    transform: rotateY(180deg);
  }
}
...
@media (hover: none) {
  .perspective-1000:active .rotate-y-180 {
    transform: rotateY(0deg);
  }

  .perspective-1000:active .rotate-y-0 {
    transform: rotateY(180deg);
  }
}
</style>
