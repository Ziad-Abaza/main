<template>
  <template v-if="!quizResultsStore.loading">
    ...
    >
      ...
      <div
        class="relative z-10 container mx-auto px-6 py-8 max-w-4xl flex items-center justify-center min-h-screen"
      >
        <!-- Confetti Particles -->
        ...
        >
          ...
          <div class="w-24 h-24 mx-auto mb-8 relative">
            ...
            >
              <svg
                v-if="quizResultsStore.percentage >= 50"
          ...
          <!-- Enhanced Title -->
          <h1
            class="text-4xl md:text-5xl font-black mb-6 bg-gradient-to-r from-teal-400 via-cyan-400 to-purple-500 bg-clip-text text-transparent drop-shadow-2xl tracking-tight"
          >
            Quiz Completed!
          </h1>
          <div
            class="w-24 h-1 bg-gradient-to-r from-teal-400 to-purple-500 rounded-full mx-auto mb-6"
          ></div>

          <!-- Enhanced Score Display -->
          <div class="mb-8">
            <p
              :class="isDark ? 'text-gray-300 text-lg' : 'text-gray-600 text-lg'"
              class="mb-2"
            >
              You answered
              <span class="font-bold text-green-500"
                >{{ quizResultsStore.correct_answers }} out of
            ...
            >
              ...
              <span class="font-bold text-blue-500 text-2xl"
                >{{ quizResultsStore.percentage }}%</span
              >
            </p>
          </div>
          ...
          >
            <div class="flex items-center justify-center space-x-3">
              ...
              <span class="text-green-600 font-bold text-lg"
                >Congratulations! You passed the quiz successfully 🎉</span
              >
            </div>
          </div>
          <div
          ...
          >
            <div class="flex items-center justify-center space-x-3">
              ...
              <span class="text-red-600 font-bold text-lg"
                >You did not pass. Try again!</span
              >
            </div>
          </div>
          ...
          <template v-if="quizResultsStore.next_video">
            <router-link
              :to="{
                name: 'video',
                params: { id: quizResultsStore.next_video.video_id },
              }"
              :class="[
      ...
      <div class="text-center">
        ...
        <div
          :class="[
            ...
            isDark ? 'glass-card-premium border-white/20' : 'bg-white border-gray-200',
          ]"
        >
          <h3
...
const mount = async () => {
  if (videoId) {
    try {
      ...
      console.log({ ...quizResultsStore.$state });
    } catch (err) {
