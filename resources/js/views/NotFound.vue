  ...
  <div class="notfound-container w-full" :class="{ dark: isDark, light: !isDark }">
    ...
    <div v-if="isDark" class="aurora-svg">
      <svg viewBox="0 0 1440 320" width="100%" height="320" preserveAspectRatio="none">
        <path class="aurora-path" d="M0,160 C360,240 1080,80 1440,160 L1440,320 L0,320 Z" fill="url(#auroraGradient)"/>
        <defs>
    ...
    <div v-if="isDark" class="meteors">
      ...
      >
        ...
        />
        <!-- Meteor head -->
        <circle cx="52" cy="6" r="4" fill="#fffbe7" fill-opacity="0.95" filter="url(#glow)"/>
        <defs>
          <linearGradient id="meteorTailGradient" x1="10" y1="28" x2="50" y2="4" gradientUnits="userSpaceOnUse">
...
@keyframes sunPulse {
  0% { filter: brightness(1) drop-shadow(0 0 12px #ffe06688); }
  100% { filter: brightness(1.15) drop-shadow(0 0 32px #ffe066cc); }
}
...
.sparkle1 { top: 120px; left: 30vw; animation-delay: 0.2s; }
.sparkle2 { top: 200px; left: 70vw; animation-delay: 1.1s; }
.sparkle3 { top: 300px; left: 50vw; animation-delay: 1.8s; }
...
@keyframes auroraWave {
  ...
  50% { transform: scaleY(1.08) translateY(10px); }
  100% { transform: scaleY(1) translateY(0); }
}
@keyframes auroraColor {
  0% { filter: blur(8px) brightness(1.2) hue-rotate(0deg); }
  50% { filter: blur(12px) brightness(1.3) hue-rotate(-10deg); }
  100% { filter: blur(8px) brightness(1.2) hue-rotate(0deg); }
}
...
@keyframes tailWiggle {
  0%   { d: path('M10 28 Q 30 10, 50 4'); }
  25%  { d: path('M10 28 Q 32 14, 50 4'); }
  50%  { d: path('M10 28 Q 28 6, 50 4'); }
  75%  { d: path('M10 28 Q 34 18, 50 4'); }
  100% { d: path('M10 28 Q 30 10, 50 4'); }
}
